...
from Yone import DEV_USERS
from Yone import pbot as app
from Yone.services.sections import section
...
async def get_chat_info(chat, already=False):
    ...
    link = f"Link (http://t.me/%7Busername%7D)" if username else None
    dc_id = chat.dc_id
...
async def info_func(_, message: Message):
    ...
    m = await message.reply_text("Searching In Database.....")
...
@app.on_message(filters.command("papainfo"))
